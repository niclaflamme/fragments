...
When everyone knows that the tests they’re being asked to review weren’t written by a human, how much effort do you think goes into reviewing them?
...
To make matters worse, the tests that are easiest for LLMs to generate are the least informative. They’re deterministic and shallow, but ultimately hard to object to in review—so they get merged.
...
Don't get me started on mocked databases: the purest form of testing nothing. Of course the mock returns the value you asked for. Real systems fail on unique constraints, transactions, timeouts, and concurrency—exactly the stuff your mock refuses to model.
...
A natural 2,500-line PR can be reviewed as one coherent thought. The same change—when forced into eight PRs—can’t. That’s eight reviews, eight context switches, and eight cycles of rebasing and merge conflicts.
...
Everyone knows the work is performative. But if playing along is what gets you back to doing real work the fastest, people will play along.
